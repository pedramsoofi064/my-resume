...
\begin{customitemize}
    ...
    \begin{customitemize}
        ...
        \begin{customitemize}
            \item[] {\stackoftech{JavaScript, Node js, Vue js }}
        ...
        \begin{customitemize}
            \item[] {\stackoftech{JavaScript, Vue js, Node js, SOLID, OOP, Testing, Dependency Injection, Design Patterns, Clean Code/Architecture}}
        ...
        \begin{customitemize}
            \item[] {\stackoftech{JavaScript, Vue js, PWA}}
        \end{customitemize}
    \end{customitemize}
